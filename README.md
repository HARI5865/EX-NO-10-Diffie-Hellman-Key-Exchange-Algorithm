...
int main() {
    ...
    printf("Enter the private key for Hari (a): ");
    scanf("%lld", &a);
    x = mod_exp(G, a, P); 


    printf("Enter the private key for Madhan (b): ");
    scanf("%lld", &b);
    y = mod_exp(G, b, P);
...
![image](https://github.com/user-attachments/assets/97f9aabf-7f4b-4630-a206-cd89de7840fe)
